...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_owner_projector_impl {
    ($ty:ident) => {
...
#[doc(inline)]
pub(crate) use __export_owner_projector_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:petclinic:owner-projector-world@0.1.0:owner-projector:encoded world"
)]
#[doc(hidden)]
...
A\x0d\x01B\x1c\x01q\x03\x0dno-such-store\0\0\x0daccess-denied\0\0\x05other\x01s\0\
...
ment\x01\x06\x03\0!wasi:keyvalue/atomics@0.2.0-draft\x05\x03\x01B\x04\x01m\x06\x05\
...
ogging/logging@0.1.0-draft\x05\x04\x01B\x04\x01p}\x01ks\x01r\x03\x07subjects\x04\
body\0\x08reply-to\x01\x04\0\x0ebroker-message\x03\0\x02\x03\0\x1fwasmcloud:mess\
aging/types@0.2.0\x05\x05\x02\x03\0\x03\x0ebroker-message\x01B\x05\x02\x03\x02\x01\
\x06\x04\0\x0ebroker-message\x03\0\0\x01j\0\x01s\x01@\x01\x03msg\x01\0\x02\x04\0\
\x0ehandle-message\x01\x03\x04\0!wasmcloud:messaging/handler@0.2.0\x05\x07\x04\0\
5petclinic:owner-projector-world/owner-projector@0.1.0\x04\0\x0b\x15\x01\0\x0fow\
ner-projector\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x07\
