...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_ui_server_impl {
    ($ty:ident) => {
...
#[doc(inline)]
pub(crate) use __export_ui_server_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:petclinic:ui-server-world@0.1.0:ui-server:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 6473] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xc91\x01A\x02\x01A\x15\
...
\x02\x03\0\x20wasi:logging/logging@0.1.0-draft\x05\0\x01B\x0a\x04\0\x08pollable\x03\
...
@\x01\x02in\x04\0\x05\x04\0\x04poll\x01\x06\x03\0\x12wasi:io/poll@0.2.0\x05\x01\x02\
\x03\0\x01\x08pollable\x01B\x0f\x02\x03\x02\x01\x02\x04\0\x08pollable\x03\0\0\x01\
...
\x12subscribe-duration\x01\x0a\x03\0!wasi:clocks/monotonic-clock@0.2.0\x05\x03\x01\
B\x04\x04\0\x05error\x03\x01\x01h\0\x01@\x01\x04self\x01\0s\x04\0\x1d[method]err\
or.to-debug-string\x01\x02\x03\0\x13wasi:io/error@0.2.0\x05\x04\x02\x03\0\x03\x05\
error\x01B(\x02\x03\x02\x01\x05\x04\0\x05error\x03\0\0\x02\x03\x02\x01\x02\x04\0\
...
utput-stream.blocking-splice\x01\x18\x03\0\x15wasi:io/streams@0.2.0\x05\x06\x02\x03\
...
0.2.0\x05\x0d\x04\0)petclinic:ui-server-world/ui-server@0.1.0\x04\0\x0b\x0f\x01\0\
\x09ui-server\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x07\
