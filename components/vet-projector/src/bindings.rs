            ...
            pub mod handler {
                ...
                macro_rules! __export_wasmcloud_messaging_handler_0_2_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        ...
                        "wasmcloud:messaging/handler@0.2.0#handle-message")] unsafe
                        ...
                        "cabi_post_wasmcloud:messaging/handler@0.2.0#handle-message")]
                        unsafe extern "C" fn _post_return_handle_message(arg0 : * mut
                        u8,) { unsafe { $($path_to_types)*::
                        __post_return_handle_message::<$ty > (arg0) } } };
                    };
                }
                #[doc(hidden)]
...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_vet_projector_impl {
    ($ty:ident) => {
        self::export!($ty with_types_in self);
    };
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::wasmcloud::messaging::handler::__export_wasmcloud_messaging_handler_0_2_0_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::wasmcloud::messaging::handler);
    };
}
#[doc(inline)]
pub(crate) use __export_vet_projector_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:petclinic:vet-projector-world@0.1.0:vet-projector:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 963] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xbf\x06\x01A\x02\x01\
A\x09\x01B\x1c\x01q\x03\x0dno-such-store\0\0\x0daccess-denied\0\0\x05other\x01s\0\
...
\0\x04\0\x03log\x01\x02\x03\0\x20wasi:logging/logging@0.1.0-draft\x05\x01\x01B\x04\
\x01p}\x01ks\x01r\x03\x07subjects\x04body\0\x08reply-to\x01\x04\0\x0ebroker-mess\
age\x03\0\x02\x03\0\x1fwasmcloud:messaging/types@0.2.0\x05\x02\x02\x03\0\x02\x0e\
broker-message\x01B\x05\x02\x03\x02\x01\x03\x04\0\x0ebroker-message\x03\0\0\x01j\
\0\x01s\x01@\x01\x03msg\x01\0\x02\x04\0\x0ehandle-message\x01\x03\x04\0!wasmclou\
d:messaging/handler@0.2.0\x05\x04\x04\01petclinic:vet-projector-world/vet-projec\
tor@0.1.0\x04\0\x0b\x13\x01\0\x0dvet-projector\x03\0\0\0G\x09producers\x01\x0cpr\
